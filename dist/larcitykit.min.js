...
e.$emit("app:auth-loginConfirmed",t),n.retryAll(o)},loginCancelled:function(t,r){n.rejectAll(r),e.$emit("app:auth-loginCancelled",t)}}}]).config(["$httpProvider",function(e){e.interceptors.push(["$rootScope","$q","httpBuffer",function(e,n,t){return{responseError:function(r){switch(console.log("Rejection >>"),console.log(r),r.status){case 401:var o=n.defer()
return t.append(r.config,o),e.$emit("app:auth-loginRequired",r),o.promise
default:var o=n.defer()
t.append(r.config,o)
var i="app:auth-intercepted"+(r.status||"")
return e.$emit(i,r),o.promise}return n.reject(r)}}}])}]),angular.module("http-auth-interceptor-buffer",[]).factory("httpBuffer",["$injector",function(e){function n(n,r){function o(e){r.resolve(e)}function i(e){r.reject(e)}t=t||e.get("$http"),t(n).then(o,i)}var t,r=[]
