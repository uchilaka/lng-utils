...
case 403:var o=n.defer()
t.append(r.config,o)
return e.$emit("app:auth-accessForbidden",r),o.promise}return n.reject(r)}}}])}]),angular.module("http-auth-interceptor-buffer",[]).factory("httpBuffer",["$injector",function(e){function n(n,r){function o(e){r.resolve(e)}function i(e){r.reject(e)}t=t||e.get("$http"),t(n).then(o,i)}var t,r=[]
