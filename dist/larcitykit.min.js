...
e=e||{}
var a=null!=e.clockseq?e.clockseq:m,c=null!=e.msecs?e.msecs:(new Date).getTime(),u=null!=e.nsecs?e.nsecs:w+1,l=c-y+(u-w)/1e4
if(l<0&&null==e.clockseq&&(a=a+1&16383),(l<0||c>y)&&null==e.nsecs&&(u=0),u>=1e4)throw new Error("uuid.v1(): Can't create more than 10M uuids/sec")
y=c,w=u,m=a,c+=122192928e5
...
var g=i(),v=[1|g[0],g[1],g[2],g[3],g[4],g[5]],m=16383&(g[6]<<8|g[7]),y=0,w=0,$=o
return $.v1=r,$.v4=o,$.parse=n,$.unparse=t,$.BufferClass=d,$._rng=i,$._mathRNG=a,$._whatwgRNG=c,$}angular.module("angular-uuid",[]).factory("uuid",["$window",e])}"undefined"!=typeof module&&module.exports?module.exports=new AngularUUID:"undefined"!=typeof define&&define.amd?define(function(){return new AngularUUID}):AngularUUID(),angular.module("larcity-constants",[]).constant("Constants",{Event:{Auth:{REQUIRED:"app:auth:loginRequired",LOGIN_CONFIRMED:"app:auth:loginConfirmed",LOGIN_CANCELED:"app:auth:loginCanceled"}},Permission:{GEOLOCATION:"permission.geolocation"}}),function(){"use strict"
...
document.dispatchEvent(n)}else console.error("larcity.js required, and not loaded!")}),angular.module("lng-services",["data.service","http-auth-interceptor","ng-larcity-standalone","angular-uuid"]).factory("$authService",["$rootScope","$dataService","$instanceStorage","$larcity","$location",function(e,n,t,r,o){console.log("[$authService]"),e.logout=function(){t.set("user",null),t.set("credentials",null),o.path("/login")}
...
return e.authHelper=i,i}]).run(["$rootScope","$comenity","$instanceStorage","$location",function(e,n,t,r){var o=function(){return new Promise(function(n,o){var i=r.search()
...
document.addEventListener("com:comenity:ready",function(){o()})}]).factory("$demoShieldService",["$rootScope","$authService","$location",function(e,n,t){console.log("[$demoShieldService]")
