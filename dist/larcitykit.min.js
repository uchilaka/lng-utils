...
document.addEventListener("com:larcity:ready",function(){o()})}]).factory("$demoShieldService",["$rootScope","$authService","$location",function(e,n,t){console.log("[$demoShieldService]")
